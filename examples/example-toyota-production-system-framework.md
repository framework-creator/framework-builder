...
**Positive indicators:**
- The translated solution addresses failure modes that weren't in the original problem statement (the transfer revealed something you didn't know to look for)
- Domain experts in the source field immediately recognize the mechanism when you describe your translation
- The solution feels obvious in retrospect rather than clever (structural matches produce elegant solutions, not complicated ones)
- The translation surfaces constraints in your domain that were previously invisible

**Failure signals:**
- The analogy requires extensive explanation to work (real structural matches are immediately recognizable)
- You're matching surface features rather than mechanisms ("both involve lots of moving parts")
- The source domain solution worked because of context that doesn't exist in your domain (a solution that required 1000 workers doesn't transfer to a two-person team)
- The insight only applies to the specific example you used to find it (not generalizable = not a real pattern)
